  ...
  return (
    <div className="hero-comparison" aria-label={`${t.hotspot} → ${t.alternative}`}>
      <article className="hero-plan-card hero-plan-original">
        ...
        <DestinationPhoto autoPlay autoPlayIntervalMs={4800} compact interactive={false} name="Neuschwanstein Castle" region="Bavaria" />
      ...
      <article className="hero-plan-card hero-plan-alternative">
        ...
        <DestinationPhoto autoPlay autoPlayIntervalMs={5600} compact interactive={false} name="Falkenstein Ruin Pfronten" region="Bavaria" />
        <div className="hero-card-facts">
